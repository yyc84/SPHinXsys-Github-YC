 ...
 */
#include "sphinxsys.h"
#include "tank_case_heat_exchange.h"
...
int main(int ac, char* av[])
{
	...
	*/
    ...
    ReduceDynamics<fluid_dynamics::AdvectionTimeStep> get_water_advection_time_step_size(water_block, U_f);
    ReduceDynamics<fluid_dynamics::AdvectionTimeStep> get_air_advection_time_step_size(air_block, U_g);
