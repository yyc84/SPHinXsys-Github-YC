...
int main(int ac, char* av[])
{
	...
	*/
    ...
    InteractionWithUpdate<fluid_dynamics::DensitySummationComplexFreeSurface> update_water_density_by_summation(water_inner, water_tank_contact);
    ...
    InteractionWithUpdate<fluid_dynamics::ViscousForceWithWall> viscous_acceleration_water(water_inner, water_tank_contact);
