...
//----------------------------------------------------------------------
//std::string full_path_to_file = "./input/simple-body.stl";
//Vec3d domain_lower_bound(-270, -95, -740);
//Vec3d domain_upper_bound(270, 122, 951);
//Vecd translation(0.0, 0.0, 0.0);
//Real scaling = 1.0; 

std::string full_path_to_file = "./input/blood-vessel.stl";
Vec3d domain_lower_bound(-91, -4, -23);
Vec3d domain_upper_bound(91, 461, 11);
Vecd translation(0.0, 0.0, 0.0);
Real scaling = 1.0;
//----------------------------------------------------------------------
//	Basic geometry parameters and numerical setup.
