...
namespace SPH
{
	...
	TwoPhaseDiffusionReactionInitialCondition<DiffusionReactionParticlesType>::
		TwoPhaseDiffusionReactionInitialCondition(SPHBody &sph_body)
		: LocalDynamics(sph_body),
		TwoPhaseDiffusionReactionSimpleData<DiffusionReactionParticlesType>(sph_body),
		pos_(this->particles_->pos_), all_species_(this->particles_->all_species_), thermal_conductivity_(this->particles_->thermal_conductivity_){}
	//=================================================================================================//
	template <class DiffusionReactionParticlesType>
	TwoPhaseGetDiffusionTimeStepSize<DiffusionReactionParticlesType>::
	...
	//=================================================================================================//
	template <class DiffusionReactionParticlesType>
	TwoPhaseRelaxationOfAllDiffusionSpeciesInner<DiffusionReactionParticlesType>::
		TwoPhaseRelaxationOfAllDiffusionSpeciesInner(BaseInnerRelation &inner_relation)
		: LocalDynamics(inner_relation.getSPHBody()),
		TwoPhaseDiffusionReactionInnerData<DiffusionReactionParticlesType>(inner_relation),
	...
	//=================================================================================================//
	template <class DiffusionReactionParticlesType>
	void TwoPhaseRelaxationOfAllDiffusionSpeciesInner<DiffusionReactionParticlesType>::
		...
		getDiffusionChangeRate(size_t particle_i, size_t particle_j, Vecd &e_ij, Real surface_area_ij)
	{
		for (size_t m = 0; m < all_diffusions_.size(); ++m)
		{
			Real diff_coff_ij = all_diffusions_[m]->getInterParticleDiffusionCoff(particle_i, particle_j, e_ij);
	...
	TwoPhaseRelaxationOfAllDiffusionSpeciesComplex<DiffusionReactionParticlesType, ContactDiffusionReactionParticlesType>::
		TwoPhaseRelaxationOfAllDiffusionSpeciesComplex(ComplexRelation& complex_relation)
		: TwoPhaseRelaxationOfAllDiffusionSpeciesInner<DiffusionReactionParticlesType>(complex_relation.getInnerRelation()),
		TwoPhaseDiffusionReactionContactData< DiffusionReactionParticlesType,
		ContactDiffusionReactionParticlesType>(complex_relation.getContactRelation()),
		thermal_conductivity_(this->particles_->thermal_conductivity_), external_diffusion_dt_(this->particles_->external_diffusion_dt_), external_diffusion_dt_sum_(this->particles_->external_diffusion_dt_sum_)
	{
		
		contact_gradient_species_.resize(this->contact_particles_.size());
		contact_thermal_conductivity_.resize(this->contact_particles_.size());
	...
	for (size_t m = 0; m < this->all_diffusions_.size(); ++m)
	{
		...
		for (size_t k = 0; k != this->contact_particles_.size(); ++k)
		{
			...
			contact_thermal_conductivity_[k].push_back(&(this->contact_particles_[k]->thermal_conductivity_));
		}
	}
	...
	//=================================================================================================//
		template <class DiffusionReactionParticlesType, class ContactDiffusionReactionParticlesType>
		void TwoPhaseRelaxationOfAllDiffusionSpeciesComplex<DiffusionReactionParticlesType, ContactDiffusionReactionParticlesType>::
	initializeExternalDiffusionChangeRate(size_t particle_i)
	{
		for (size_t m = 0; m < this->all_diffusions_.size(); ++m)
		{
			external_diffusion_dt_[particle_i] = 0;
			//external_diffusion_dt_sum_[particle_i] = 0;
		}
	}
	template <class DiffusionReactionParticlesType, class ContactDiffusionReactionParticlesType>
	void TwoPhaseRelaxationOfAllDiffusionSpeciesComplex<DiffusionReactionParticlesType, ContactDiffusionReactionParticlesType>::
		getDiffusionChangeRateContact(size_t particle_i, size_t particle_j, Vecd& e_ij,
			Real surface_area_ij, const StdVec<StdLargeVec<Real>*>& gradient_species_k, const  StdVec<StdLargeVec<Real>*>& thermal_conductivity_k)
	{
		for (size_t m = 0; m < this->all_diffusions_.size(); ++m)
		{
			Real totalsum = (*thermal_conductivity_k[m])[particle_j] + thermal_conductivity_[particle_i];
			Real diff_coff_ij =
				this->all_diffusions_[m]->getInterParticleDiffusionCoff(particle_i, particle_j, e_ij) * (*thermal_conductivity_k[m])[particle_j] / totalsum;
			...
			(*this->diffusion_dt_[m])[particle_i] += external_diffusion_dt_[particle_i];
		}
	}
	//=================================================================================================//
	template <class DiffusionReactionParticlesType, class ContactDiffusionReactionParticlesType>
	...
	void TwoPhaseRelaxationOfAllDiffusionSpeciesComplex<DiffusionReactionParticlesType, ContactDiffusionReactionParticlesType>::
		interaction(size_t index_i, Real dt)
	{
		TwoPhaseRelaxationOfAllDiffusionSpeciesInner<DiffusionReactionParticlesType>::interaction(index_i, dt);
		DiffusionReactionParticlesType* particles = this->particles_;
		...
		for (size_t k = 0; k < this->contact_configuration_.size(); ++k)
		{
			...
			StdVec<StdLargeVec<Real>*>& thermal_conductivity_k = (contact_thermal_conductivity_[k]);
			...
			for (size_t n = 0; n != contact_neighborhood.current_size_; ++n)
			{
				...
				const Vecd& grad_ijV_j = particles->getKernelGradient(index_i, index_j, dW_ijV_j_, e_ij);
				Real area_ij = 2.0 * grad_ijV_j.dot(e_ij) / r_ij_;
				getDiffusionChangeRateContact(index_i, index_j, e_ij, area_ij, gradient_species_k, thermal_conductivity_k);
	...
	//=================================================================================================//
	template <class DiffusionReactionParticlesType>
	TwoPhaseInitializationRK<DiffusionReactionParticlesType>::
		TwoPhaseInitializationRK(SPHBody& sph_body, StdVec<StdLargeVec<Real>>&diffusion_species_s)
		: LocalDynamics(sph_body),
		TwoPhaseDiffusionReactionSimpleData<DiffusionReactionParticlesType>(sph_body),
		material_(this->particles_->diffusion_reaction_material_),
		all_diffusions_(material_.AllDiffusions()),
	...
	//=================================================================================================//
	template <class DiffusionReactionParticlesType>
	void TwoPhaseInitializationRK<DiffusionReactionParticlesType>::
		update(size_t index_i, Real dt)
	{
		for (size_t m = 0; m < all_diffusions_.size(); ++m)
		{
