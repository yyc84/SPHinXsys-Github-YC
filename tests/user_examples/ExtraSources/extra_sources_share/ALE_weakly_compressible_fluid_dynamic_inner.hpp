...
#ifndef ALE_WEAKLY_COMPRESSIBLE_FLUID_DYNAMIC_INNER_HPP
#define ALE_WEAKLY_COMPRESSIBLE_FLUID_DYNAMIC_INNER_HPP
	...
	namespace ALE_weakly_compressible_fluid_dynamic
	{
		...
		void BaseIntegration1stHalf<RiemannSolverType>::interaction(size_t index_i, Real dt)
		{
			...
			for (size_t n = 0; n != inner_neighborhood.current_size_; ++n)
			{
				...
				momentum_change_rate -= 2.0 * (interface_state.p_ * Matd::Identity()) * e_ij * dW_ijV_j;
			}
...
#endif // ALE_WEAKLY_COMPRESSIBLE_FLUID_DYNAMIC_INNER_HPP
