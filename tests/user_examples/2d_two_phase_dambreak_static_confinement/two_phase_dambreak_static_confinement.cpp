...
int main()
{
	...
	//air_pressure_relaxation.post_processes_.push_back(&confinement_condition_air.extend_intergration_1st_half_Velocity);
	air_pressure_relaxation.post_processes_.push_back(&confinement_condition_water.pressure_relaxation_);
