...
#ifndef	CYLINDER_TANK_VALIDATION_H
#define CYLINDER_TANK_VALIDATION_H
...
BoundingBox system_domain_bounds(Vec3d(-0.2, -0.2, -0.03), Vec3d(0.2, 0.2, 0.5));
...
std::string fuel_tank_outer = "./input/cylindrical_tank_outer_01.stl";
std::string fuel_tank_inner = "./input/cylindrical_tank_inner_01.stl";
std::string water_05 = "./input/cylindrical_water_01.stl";
std::string air_05 = "./input/cylindrical_gas_01.stl";
