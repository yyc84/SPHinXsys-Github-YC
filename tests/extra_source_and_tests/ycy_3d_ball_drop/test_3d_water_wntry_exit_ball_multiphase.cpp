...
int main(int ac, char *av[])
{
    ...
    ContactRelation water_wall_contact(water_block, {&wall_boundary, &cylinder});
    ContactRelation water_air_wall_contact(water_block, {&air_block, &wall_boundary, &cylinder});

    InnerRelation air_block_inner(air_block);
    ContactRelation air_water_contact(air_block, {&water_block});
    ContactRelation air_wall_contact(air_block, {&wall_boundary, &cylinder});
    ContactRelation air_water_wall_contact(air_block, {&water_block, &wall_boundary, &cylinder});
