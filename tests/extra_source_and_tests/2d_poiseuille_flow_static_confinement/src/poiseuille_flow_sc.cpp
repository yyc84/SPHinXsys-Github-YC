...
int main(int ac, char *av[])
{
    ...
    viscous_acceleration.post_processes_.push_back(&confinement_condition_up.viscous_force_);
    ...
    viscous_acceleration.post_processes_.push_back(&confinement_condition_down.viscous_force_);
    /**
