    ...
    : public DiffusionRelaxation<DataDelegateContact, DiffusionType>
{
  ...
  public:
    ...
    explicit DiffusionRelaxation(BodyRelationType &contact_body_relation,  StdVec<ContactDiffusionType *> contact_diffusions);

    template <typename BodyRelationType>
    explicit DiffusionRelaxation(BodyRelationType &contact_body_relation, ContactDiffusionType *contact_diffusion);
...
class HeatExchangeDiffusionComplex : public LocalDynamics
{
  public:
    ...
    template <typename BodyRelationInnerType, typename BodyRelationContactType>
    explicit HeatExchangeDiffusionComplex(BodyRelationInnerType &body_relation, BodyRelationContactType &contact_body_relation, ContactDiffusionType *contact_diffusion)
        : HeatExchangeDiffusionComplex(body_relation, contact_body_relation, StdVec<ContactDiffusionType *>{contact_diffusion}){};

    template <typename BodyRelationInnerType, typename BodyRelationContactType>
    explicit HeatExchangeDiffusionComplex(BodyRelationInnerType &body_relation, BodyRelationContactType &contact_body_relation, StdVec<ContactDiffusionType *> contact_diffusions)
        : LocalDynamics(body_relation.getSPHBody()), inner_relaxation_(body_relation),
          heat_exchange_relaxation_(contact_body_relation, contact_diffusions){};
